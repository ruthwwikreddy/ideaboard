...
const PLAN_DETAILS = {
  "free": { name: "Free", generations: 1, features: ["1 Free Generation", "Basic Analytics"] },
  "basic": { name: "Basic Pack", generations: 5, features: ["5 AI Generations", "Standard Analytics", "Email Support"] },
  "premium": { name: "Premium Pack", generations: 10, features: ["10 AI Generations", "Advanced Analytics", "Priority Support"] },
};
          ...
          {(Object.keys(PLAN_DETAILS) as PlanId[]).map((planId) => (
            <Card key={planId} className={`flex flex-col ${currentPlanId === planId ? "border-primary ring-2 ring-primary" : ""}`}>
              <CardHeader>
                ...
                <CardDescription>{PLAN_DETAILS[planId].generations} Credits</CardDescription>
              </CardHeader>
